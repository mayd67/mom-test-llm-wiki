...
tags:
  ...
  - mirror
  - auto-ingest
summary: 自动镜像 wiki/02_HX项目资料/99_原始资料/bjhx_process/README.md，作为当前 legacy wiki 结构下的安全入库入口。
source:
  - wiki/02_HX项目资料/99_原始资料/bjhx_process/README.md
updated: 2026-05-27
---
...
- 原始路径：`wiki/02_HX项目资料/99_原始资料/bjhx_process/README.md`
- 目标路径：`wiki/02_HX项目资料/99_原始资料镜像/bjhx_process/README.md`
- 提取方式：`markdown`
...
详见 [项目概况.md](../../../../wiki/02_HX项目资料/99_原始资料/bjhx_process/项目概况.md)
