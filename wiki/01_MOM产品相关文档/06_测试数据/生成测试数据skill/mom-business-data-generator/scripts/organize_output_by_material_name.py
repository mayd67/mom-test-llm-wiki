...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description='将 output 下已生成的 MOM 数据包按物料中文名称分类整理。')
    parser.add_argument('--output-root', default='output', help='原始 output 根目录，默认 output')
    parser.add_argument('--target-root', default='output/按物料中文名称分类', help='中文分类目录，默认 output/按物料中文名称分类')
