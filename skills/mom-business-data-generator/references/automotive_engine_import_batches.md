...
- 导出目录：`outputs/06_测试数据/automotive_engine_seed`
...
- 导出目录：`outputs/06_测试数据/automotive_engine_seed_big`
...
- 导出目录：`outputs/06_测试数据/automotive_engine_seed_ultra`
...
1. 先导入 `outputs/06_测试数据/automotive_engine_seed`
2. 再导入 `outputs/06_测试数据/automotive_engine_seed_big`
3. 最后导入 `outputs/06_测试数据/automotive_engine_seed_ultra`
...
- 历史目录 `outputs/06_测试数据/_deprecated/automotive_engine_seed_v2`、`outputs/06_测试数据/_deprecated/automotive_engine_seed_v3`、`outputs/06_测试数据/_deprecated/automotive_engine_seed_big_ns31`、`outputs/06_测试数据/_deprecated/automotive_engine_seed_ultra_ns42` 已迁入归档目录；当前推荐使用标准目录 `outputs/06_测试数据/automotive_engine_seed`、`outputs/06_测试数据/automotive_engine_seed_big`、`outputs/06_测试数据/automotive_engine_seed_ultra`。
