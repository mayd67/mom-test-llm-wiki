...
`wiki/02_HX项目资料/` 当前用于承接 HX/BJHX 项目级资料，主要放：

- 项目测试总览
- 环境与风险测试关注点
- 重点需求测试分析页

`wiki/03_QD项目资料/` 当前用于承接天府轻动 QD 项目级资料，主要放：
...
- 对项目风险、环境约束、项目定制需求，应优先查看对应项目目录，如 `wiki/02_HX项目资料/` 或 `wiki/03_QD项目资料/`
...
- `02_HX项目资料/`、`03_QD项目资料/` 中项目页与产品资料页边界清晰
